...
import TestiranjeB6 from './TestiranjeB6';
...
class B6 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B6</div>
    ...
    getData() {
        var test = require('./pitanja/B6/kviz.json'),
            pitanja = require('./pitanja/B6/pitanja.json');
