...
import TestiranjeB8 from './TestiranjeB8';
...
class B8 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B8</div>
    ...
    getData() {
        var test = require('./pitanja/B8/kviz.json'),
            pitanja = require('./pitanja/B8/pitanja.json');
