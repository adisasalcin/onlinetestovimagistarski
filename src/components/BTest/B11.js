...
import TestiranjeB11 from './TestiranjeB11';


class B11 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B11</div>
    ...
    getData() {
        var test = require('./pitanja/B11/kviz.json'),
            pitanja = require('./pitanja/B11/pitanja.json');
