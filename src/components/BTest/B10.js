...
import TestiranjeB10 from './TestiranjeB10';


class B10 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B10</div>
    ...
    getData() {
        var test = require('./pitanja/B10/kviz.json'),
            pitanja = require('./pitanja/B10/pitanja.json');
