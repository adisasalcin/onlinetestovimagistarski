...
import TestiranjeB12 from './TestiranjeB12';
...
class B12 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B12</div>
    ...
    getData() {
        var test = require('./pitanja/B12/kviz.json'),
            pitanja = require('./pitanja/B12/pitanja.json');
