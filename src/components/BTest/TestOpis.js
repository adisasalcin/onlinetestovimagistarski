    ...
    render() {
        return (
            <section className="opistestova">
              <p>B – kategorija je dozvola za upravljanje putničkim vozilom, tj vozilima čija
               masa nije veća od 3.5t i nemaju više od 8 mjesta za sjedenje ne računajući
               sjedište za vozača.</p>
              <p>Obuka vozača se može vršiti sa navršenih 16 godina, a polaganje vozačkog ispita
              sa 17 godina.</p>
              <p>Obuka podrazumjeva 40 časova teorije i 40 časova praktične obuke. Nakon završene
              teoretske obuke polaže se teoretski dio ispita, a nakon završene praktične obuke i
              praktični dio ispita.</p>
