...
import TestiranjeB13 from './TestiranjeB13';


class B13 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B13</div>
    ...
    getData() {
        var test = require('./pitanja/B13/kviz.json'),
            pitanja = require('./pitanja/B13/pitanja.json');
