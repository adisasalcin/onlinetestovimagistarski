...
import TestiranjeB7 from './TestiranjeB7';
...
class B7 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B7</div>
    ...
    getData() {
        var test = require('./pitanja/B7/kviz.json'),
            pitanja = require('./pitanja/B7/pitanja.json');
