...
const p=require('./pitanja/B1/slike/praznaslika.png');
const znak1=require('./pitanja/B1/slike/znak1.png');
const znak2=require('./pitanja/B1/slike/znak2.png');
const znak3=require('./pitanja/B1/slike/znak3.png');
const znak4=require('./pitanja/B1/slike/znak4.png');
const znak5=require('./pitanja/B1/slike/znak5.png');
const znak6=require('./pitanja/B1/slike/znak6.png');
const znak7=require('./pitanja/B1/slike/znak7.png');
const znak8=require('./pitanja/B1/slike/znak8.png');
const znak9=require('./pitanja/B1/slike/znak9.png');
const znak10=require('./pitanja/B1/slike/znak10.png');
const raskrsnica1=require('./pitanja/B1/slike/raskrsnica1.png');
const raskrsnica2=require('./pitanja/B1/slike/raskrsnica2.png');
const raskrsnica3=require('./pitanja/B1/slike/raskrsnica3.png');
const raskrsnica4=require('./pitanja/B1/slike/raskrsnica4.png');
const raskrsnica5=require('./pitanja/B1/slike/raskrsnica5.png');
const raskrsnica6=require('./pitanja/B1/slike/raskrsnica6.png');
const raskrsnica7=require('./pitanja/B1/slike/raskrsnica7.png');
const raskrsnica8=require('./pitanja/B1/slike/raskrsnica8.png');
const raskrsnica9=require('./pitanja/B1/slike/raskrsnica9.png');
const raskrsnica10=require('./pitanja/B1/slike/raskrsnica10.png');
