...
import TestiranjeB2 from './TestiranjeB2';
...
class B2 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B2</div>
    ...
    getData() {
        var test = require('./pitanja/B2/kviz.json'),
            pitanja = require('./pitanja/B2/pitanja.json');
