...
import TestiranjeB4 from './TestiranjeB4';
...
class B4 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B4</div>
    ...
    getData() {
        var test = require('./pitanja/B4/kviz.json'),
            pitanja = require('./pitanja/B4/pitanja.json');
