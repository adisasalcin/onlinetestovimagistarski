...
import TestiranjeB5 from './TestiranjeB5';
...
class B5 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B5</div>
    ...
    getData() {
        var test = require('./pitanja/B5/kviz.json'),
            pitanja = require('./pitanja/B5/pitanja.json');
