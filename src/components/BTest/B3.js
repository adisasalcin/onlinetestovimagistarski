...
import TestiranjeB3 from './TestiranjeB3';
...
class B3 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test B3</div>
    ...
    getData() {
        var test = require('./pitanja/B3/kviz.json'),
            pitanja = require('./pitanja/B3/pitanja.json');
