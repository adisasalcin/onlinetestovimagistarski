...
import TestiranjeC from './TestiranjeC';
...
class C3 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Dodatni test C3</div>
    ...
    getData() {
        var test = require('./pitanja/C3/kviz.json'),
            pitanja = require('./pitanja/C3/pitanja.json');
