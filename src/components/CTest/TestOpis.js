...
export default class TestOpis extends React.Component {
    ...
    render() {
        return (
          ...
          <p>Kako bi se pristupilo obuci C kategorije kandidat mora imati:
          <ul>
          <li>vozačku dozvolu sa potkategorijom C1 najmanje godinu dana i </li>
          <li>najmanje 21 godinu starosti.</li>
          </ul></p>

          <p>Obuka za C1 kategoriju traje 10 nastavnih časova. Kako bi se pristupilo obuci C1 kategorije kandidat mora imati:
          <ul>
