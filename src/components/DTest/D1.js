...
import TestiranjeD from './TestiranjeD';
...
class D1 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Dodatni test D1</div>
    ...
    getData() {
        var test = require('./pitanja/D1/kviz.json'),
            pitanja = require('./pitanja/D1/pitanja.json');
