...
import TestiranjeP from './TestiranjeP';
...
class P10 extends React.Component {
    ...
    render() {
        return (
            <div className="App"><div className="naslovi">Test P10</div>
    ...
    getData() {
        var test = require('./kviz.json'),
            pitanja = require('./pitanja/P10/pitanja.json');
